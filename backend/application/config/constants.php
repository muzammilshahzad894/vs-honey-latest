...
if ($_SERVER['HTTP_HOST'] != 'localhost') {
	...
	define('API_PUBLIC_KEY', 'pk_test_51MdVE1EAyLSzWUvFRn0TqeKIvXdG9wJO13NKkdd2RZhuMZshbwp8SyWsWusIMXnpbOnG5OEahNJileYxeyD0L5HW00AmFXA1AK');
	define('API_SECRET_KEY', 'sk_test_51MdVE1EAyLSzWUvFcfxeFOukfKE86iKgOxrexVvBooym9SvTRKyVXDT290ZZQ8FFQgGbwtMfAy0iHM2cT3yptFc300T5LGxIuG');
} else {
	// define('API_PUBLIC_KEY', 'pk_test_NthcfPBoehkm2AT0fecUIB2w0080vhuO5E');
	// define('API_SECRET_KEY', 'sk_test_4yKglgTyIxCetlNijlRBh2zN00MWjZFHsv');
	define('API_PUBLIC_KEY', 'pk_test_51MdVE1EAyLSzWUvFRn0TqeKIvXdG9wJO13NKkdd2RZhuMZshbwp8SyWsWusIMXnpbOnG5OEahNJileYxeyD0L5HW00AmFXA1AK');
