                                ...
                                <table width="100%" cellspacing="0" cellpadding="0" border=".5" style="border-color:#fbfbfb6b;">
                                    <thead>
                                        <tr style="text-align:left;">
                                            <th style="padding:7px 10px; color: #fff;background-color: #1355ff;">Subscription Plan</th>
                                            <th style="padding:7px 10px;color: #fff;background-color: #1355ff;">Price</th>
                                            <th style="padding:7px 10px;color: #fff;background-color: #1355ff;">Renews</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr>
                                            <td style="padding:7px 10px;"><?=$mem_data['plan_detail']->plan_name?></td>
                                            <td style="padding:7px 10px;">£<?=$mem_data['plan_detail']->price?></td>
                                            <td style="padding:7px 10px;">Renews until cancelled.</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </td>
