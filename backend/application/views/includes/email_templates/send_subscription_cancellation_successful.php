                ...
                <table style="background: #fff; color: #333; font-size: 13px; border-collapse: collapse;" width="100%" cellspacing="0" cellpadding="5" border="0">
                    <tbody>
                        ...
                        <tr>
                            ...
                            Your <?=$mem_data['plan_name']?> for <?=$site_settings->site_name?> has been cancelled. Thanks for using <?=$site_settings->site_name?>, and we wish you all the best in your future endeavours.
                            <br/>
                            <br/>
                            Have a nice day!
                            <br/>
