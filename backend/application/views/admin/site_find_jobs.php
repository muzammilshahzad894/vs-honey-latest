<?php echo getBredcrum(ADMIN, array('#' => 'Jobs Page')); ?>
<?php echo showMsg(); ?>
<div class="row margin-bottom-10">
    <div class="col-md-6">
        <h2 class="no-margin"><i class="entypo-window"></i> Update <strong>Jobs Page</strong></h2>
    </div>
        ...
        <h3> Page Title </h3>
            ...
            <div class="form-group">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <label for="banner_field_heading_2" class="control-label"> Field 2 Heading <span class="symbol required">*</span></label>
                            <input type="text" name="banner_field_heading_2" value="<?= $row['banner_field_heading_2'] ?>" class="form-control" required>
                        </div>
                        <div class="col-md-12">
            ...
            <div class="form-group">
                <div class="col-md-12">
                    <div class="form-group">
                        <div class="col-md-12">
                            <label for="fea_heading" class="control-label"> Heading <span class="symbol required">*</span></label>
                            <input type="text" name="fea_heading" value="<?= $row['fea_heading'] ?>" class="form-control" required>
                        </div>
                        <div class="col-md-12">
                            <label for="fea_tagline" class="control-label"> Heading Tagline <span class="symbol required">*</span></label>
                            <input type="text" name="fea_tagline" value="<?= $row['fea_tagline'] ?>" class="form-control" required>
                        </div>
