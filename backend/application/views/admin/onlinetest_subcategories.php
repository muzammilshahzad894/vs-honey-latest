...
<?= getBredcrum(ADMIN, array('#' => 'Add/Update Online Test Sub Category')); ?>

<div class="row margin-bottom-10">

    <div class="col-md-6">

        <h2 class="no-margin"><i class="entypo-list"></i> Add/Update <strong>Online Test Sub Category</strong></h2>

    </div>

    <div class="col-md-6 text-right">

        <a href="<?= base_url(ADMIN . '/onlinetest_subcategories'); ?>" class="btn btn-lg btn-default"><i class="fa fa-arrow-left"></i> Cancel</a>
...
<?= getBredcrum(ADMIN, array('#' => 'Manage Online Test Sub Categories')); ?>

<div class="row margin-bottom-10">

    <div class="col-md-6">

        <h2 class="no-margin"><i class="entypo-list"></i> Manage <strong>Online Test Sub Categories</strong></h2>

    </div>

    <div class="col-md-6 text-right">

        <a href="<?= base_url(ADMIN . '/onlinetest_subcategories/manage'); ?>" class="btn btn-lg btn-primary"><i class="fa fa-plus-circle"></i> Add New</a>

    </div>

</div>

<form method="post" action="<?=base_url('admin/onlinetest_subcategories/deleteAll')?>">
        ...
        <?php if (count($rows) > 0): $count = 0; ?>
            ...
            <?php foreach ($rows as $row): ?>
                ...
                <tr class="odd gradeX">
                    ...
                    <td><img src="<?= !empty($row->image) ? get_site_image_src("online_test_sub_categories", $row->image) : 'http://placehold.it/3000x1000' ?>" alt="--" height="80" class="image"></td>

                    <td><b><?= get_online_test_cat($row->cat_id); ?></b></td>
                    <td><b><?= $row->title; ?></b></td>

                    <td><b><?= short_text($row->page_description,100); ?></b></td>
                    ...
                    <td class="text-center">
                        ...
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu dropdown-primary" style="left:inherit;right:0;" role="menu">
                                ...
                                <li><a href="<?= site_url(ADMIN.'/onlinetest_subcategories/manage/'.$row->id); ?>">Edit</a></li>

                                <li><a href="<?= site_url(ADMIN.'/onlinetest_subcategories/delete/'.$row->id); ?>" onclick="return confirm('Are you sure?');">Delete</a></li>

                                <li>

                                    <a href="<?= site_url(ADMIN.'/onlinetest_subcategories/changestatus/'.$row->id); ?>" onclick="return confirm('Do you want to change status?');">
