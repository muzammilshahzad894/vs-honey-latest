<?php echo getBredcrum(ADMIN, array('#' => 'University Vs Employer')); ?>
<?php echo showMsg(); ?>
<div class="row margin-bottom-10">
    <div class="col-md-6">
        <h2 class="no-margin"><i class="entypo-window"></i> Update <strong>University Vs Employer</strong></h2>
    </div>
        ...
        <div class="form-group">
            <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-12">
                        <label for="left_sec_card_link" class="control-label">Link<span class="symbol required">*</span></label>
            ...
            <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-12">
                        <label for="right_sec_card_link" class="control-label">Link<span class="symbol required">*</span></label>
