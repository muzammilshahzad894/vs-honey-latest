<?php echo getBredcrum(ADMIN, array('#' => 'Video Interview Main Page')); ?>
<?php echo showMsg(); ?>
<div class="row margin-bottom-10">
    <div class="col-md-6">
        <h2 class="no-margin"><i class="entypo-window"></i> Update <strong>Video Interview Main Page</strong></h2>
    </div>
