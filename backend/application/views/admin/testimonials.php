            ...
            <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-12">
                        ...
                        <input type="number" name="rating" id="rating" value="<?php if (isset($row->rating)) echo $row->rating; ?>" class="form-control" required>
                    </div>
                    <!-- <div class="col-md-12">
            ...
            <?php if (count($rows) > 0): $count = 0; ?>
                <?php foreach ($rows as $row): ?>
                    <tr class="odd gradeX">
                        ...
                        <td><b><?= $row->rating;?><?=$row->rating > 1 ? ' stars' : ' star';?></b></br>&emsp;<?= short_text($row->detail); ?></td>
