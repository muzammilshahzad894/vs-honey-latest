<?php echo getBredcrum(ADMIN, array('#' => 'CV Page')); ?>
<?php echo showMsg(); ?>
<div class="row margin-bottom-10">
    <div class="col-md-6">
        <h2 class="no-margin"><i class="entypo-window"></i> Update <strong>CV Page</strong></h2>
    </div>
                        ...
                        <div class="form-group">
                            <div class="col-md-12">
                                <table class="table table-bordered newTable" id="newTable">
                                    ...
                                    <?php $sec2s = getMultiText('cv-page-left-instructions'); ?>
