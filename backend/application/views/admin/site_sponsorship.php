<?php echo getBredcrum(ADMIN, array('#' => 'Sponsorships And Relationships')); ?>
<?php echo showMsg(); ?>
<div class="row margin-bottom-10">
    <div class="col-md-6">
        <h2 class="no-margin"><i class="entypo-window"></i> Update <strong>Sponsorships And Relationships</strong></h2>
    </div>
            ...
            <div class="form-group">
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <label for="contact_email" class="control-label"> Contact Us Email <span class="symbol required">*</span></label>
                            <input type="text" name="contact_email" value="<?= $row['contact_email'] ?>" class="form-control" required>
                        </div>
                    </div>
                </div>
            </div>
