...
<?= getBredcrum(ADMIN, array('#' => 'Add/Update Video Interview Category')); ?>

<div class="row margin-bottom-10">

    <div class="col-md-6">

        <h2 class="no-margin"><i class="entypo-list"></i> Add/Update <strong>Video Interview Category</strong></h2>

    </div>

    <div class="col-md-6 text-right">

        <a href="<?= base_url(ADMIN . '/video_interview_categories'); ?>" class="btn btn-lg btn-default"><i class="fa fa-arrow-left"></i> Cancel</a>
        ...
        <form action="" name="frmGuide Categoreis" role="form" class="form-horizontal blog-form" method="post" enctype="multipart/form-data">
            ...
            <div style="margin:45px 0px" class="">
                ...
                <div class="panel-body">
                    ...
                    <div class="fileinput-new thumbnail" style="max-width: 310px; height: 110px;" data-trigger="fileinput">
                            ...
                            <img src="<?= !empty($row->image) ? get_site_image_src("video_interview_categories", $row->image) : 'http://placehold.it/700x620' ?>" alt="--">
            ...
            <div class="form-group">
                ...
                <div class="col-md-12">
                    ...
                    <textarea type="text" name="description" id="description" class="form-control ckeditor" required><?php if (isset($row->description)) echo $row->description; ?></textarea>
...
<?= getBredcrum(ADMIN, array('#' => 'Manage Video Interview Categories')); ?>

<div class="row margin-bottom-10">

    <div class="col-md-6">

        <h2 class="no-margin"><i class="entypo-list"></i> Manage <strong>Video Interview Categories</strong></h2>

    </div>

    <div class="col-md-6 text-right">

        <a href="<?= base_url(ADMIN . '/video_interview_categories/manage'); ?>" class="btn btn-lg btn-primary"><i class="fa fa-plus-circle"></i> Add New</a>

    </div>

</div>

<form method="post" action="<?=base_url('admin/video_interview_categories/deleteAll')?>">
        ...
        <?php if (count($rows) > 0): $count = 0; ?>
            ...
            <?php foreach ($rows as $row): ?>
                ...
                <tr class="odd gradeX">
                    ...
                    <td><img src="<?= !empty($row->image) ? get_site_image_src("video_interview_categories", $row->image) : 'http://placehold.it/3000x1000' ?>" alt="--" height="80" class="image"></td>

                    <td><b><?= $row->name; ?></b></td>

                    <td><b><?= short_text($row->page_heading,100); ?></b></td>
                    <td><b><?= short_text($row->page_detail,100); ?></b></td>
                    ...
                    <td class="text-center">
                        ...
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu dropdown-primary" style="left:inherit;right:0;" role="menu">
                                ...
                                <li><a href="<?= site_url(ADMIN.'/video_interview_categories/manage/'.$row->id); ?>">Edit</a></li>

                                <li><a href="<?= site_url(ADMIN.'/video_interview_categories/delete/'.$row->id); ?>" onclick="return confirm('Are you sure?');">Delete</a></li>

                                <li>

                                    <a href="<?= site_url(ADMIN.'/video_interview_categories/changestatus/'.$row->id); ?>" onclick="return confirm('Do you want to change status?');">
