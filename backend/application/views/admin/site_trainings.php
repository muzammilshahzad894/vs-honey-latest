<?php echo getBredcrum(ADMIN, array('#' => 'Trainings Page')); ?>
<?php echo showMsg(); ?>
<div class="row margin-bottom-10">
    <div class="col-md-6">
        <h2 class="no-margin"><i class="entypo-window"></i> Update <strong>Trainings Page</strong></h2>
    </div>
        ...
        <h3> Page Title </h3>
            ...
            <div class="form-group">
                <div class="col-md-12">
                    <div class="form-group">
                        <div class="col-md-12">
                            <label for="last_para" class="control-label"> Detail <span class="symbol required">*</span></label>
                            <textarea name="last_para" rows="4" class="form-control ckeditor" ><?= $row['last_para'] ?></textarea>
                        </div>
                    </div>
                </div>
            </div>
